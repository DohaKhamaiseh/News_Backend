...
urlpatterns = [
    ...
    path("readinglist/", CreateReadingList.as_view(), name="readinglist"),
    path("readinglist/<int:pk>/", DeleteReadingList.as_view(), name="readinglist"),
    path("readinglist/<int:user_id>/", GetReadingList.as_view(), name="readinglist"),
...
# test get reading list : http://127.0.0.1:8000/api/v1/dailypulse/readinglist/<user_id>
# method:GET
